...
export default function MembersPage() {
  ...
  // C5 fix: look up the token address and wire delegate
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-white/10 bg-white/[0.02]">
        <CardHeader>
          <CardTitle className="text-lg">Delegate Voting Power</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-400">
            Delegate your voting power to another member. They will vote on your
            behalf. You can reclaim your voting power at any time by delegating
            back to yourself.
          </p>
          <div className="flex gap-3">
            ...
            />
            <Button
              disabled={!isConnected || !isAddress(delegateAddress) || isDelegating || isDelegateConfirming}
          ...
          {delegateError && (
            <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-300">
              Delegation failed: {delegateError.message.slice(0, 200)}
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="mt-4 text-gray-400">
              Member data is indexed from on-chain events.
            </p>
            <p className="text-sm text-gray-500">
              Connect to the contract to view token holders and their voting
              power.
            </p>
          </div>
        </CardContent>
